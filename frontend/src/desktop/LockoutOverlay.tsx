 ...
 * which are shell-side (keychain + network to logicraftstudios.tech).
 */
...
const COPY: Record<LockoutReason, { title: string; subtitle: string; primary: string }> = {
  no_credential: {
    ...
    subtitle:
      'Logicraft Studios Desktop requires an account. Start your 30-day free trial - no credit card needed.',
  ...
  expired: {
    ...
    subtitle:
      'Reactivate your Logicraft Studios Pro subscription to keep using Logicraft Studios Desktop.',
