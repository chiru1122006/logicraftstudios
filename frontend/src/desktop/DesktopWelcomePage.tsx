 ...
 *      `https://logicraftstudios.tech/auth/desktop?state=<nonce>`. The page hands
      ...
      <div className="vlx-desktop-welcome-card">
        <div className="vlx-desktop-welcome-brand">
          <img
            ...
            className="vlx-desktop-welcome-logo"
            style={{ width: '48px', height: '48px', objectFit: 'contain', marginBottom: '16px' }}
          />
          <h1>{isGrandfather ? 'Welcome back to Logicraft Studios Desktop' : 'Logicraft Studios Desktop'}</h1>
          <p>
            {isGrandfather
              ? `You have ${grandfatherDaysRemaining} days to keep using Logicraft Studios Desktop before a Logicraft Studios Pro subscription is required.`
        ...
        {mode === 'choose' && (
          <div className="vlx-desktop-welcome-actions">
            ...
            >
              {waiting ? 'Waiting for browser...' : 'Sign in with Logicraft Studios'}
            </button>
            <button
              type="button"
