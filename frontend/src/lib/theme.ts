/* Theme mode — the app half of the logicraftstudios.tech-wide light/dark preference.
 *
 ...
 *   unset  means 'dark'                      ← logicraftstudios.tech is dark by default,
...
/** Storage keys owned by the other two logicraftstudios.tech surfaces. Kept in sync on
 ...
 *  another tab (or another logicraftstudios.tech surface) changes the preference. */
