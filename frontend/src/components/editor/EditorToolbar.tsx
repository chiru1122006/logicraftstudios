...
export const EditorToolbar = ({
    ...
    for (const board of boardsList) {
      ...
      try {
        ...
        const result = await compileCode(
          ...
          { boardOptions: board.boardOptions, spiffsFiles: board.spiffsFiles, boardKind: board.boardKind, exampleId: useProjectStore.getState().currentExampleId, libraries: board.libraries, language: board.languageMode === 'espidf' ? 'espidf' : undefined },
        );
   ...
   *  so on logicraftstudios.tech a .vlx could be imported but never produced. */
            ...
            {targetCount > 1 && (
              <>
                ...
                {!isMultiBoard && (
                  ...
                  >
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M4 5.14v13.72a1 1 0 0 0 1.5.86l7-4.34a1 1 0 0 0 0-1.72L5.5 4.28A1 1 0 0 0 4 5.14z" />
                      <path d="M13 5.14v13.72a1 1 0 0 0 1.5.86l7-4.34a1 1 0 0 0 0-1.72L14.5 4.28A1 1 0 0 0 13 5.14z" />
                    </svg>
                  </button>
                )}
              </>
