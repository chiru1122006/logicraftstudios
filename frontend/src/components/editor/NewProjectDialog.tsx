...
const BOARD_BLURBS: Record<string, string> = {
  ...
  'aries-v3': 'C-DAC VEGA THEA-1 RISC-V 32-bit SoC, 100MHz, 256KB SRAM, 2MB Flash (Added: 11-09-2026)',
};
    ...
    <div className="new-project-overlay" onClick={onClose}>
      ...
      >
        <div className="new-project-head">
          <div className="new-project-head-brand">
            <img
              src="/logicraft_logo.png"
              alt="Logicraft Studios Logo"
              className="new-project-brand-logo"
            />
            <div>
