...
import './velxio-components/AriesV3Element'; // registers velxio-aries-v3
  ...
  return createPortal(
    <div className="component-picker-overlay" onClick={onClose}>
      <div className="component-picker-modal" onClick={(e) => e.stopPropagation()}>
        {/* Header: title + close on top row, search + category filter below */}
        <div className="modal-header">
          <div className="modal-header-top">
            <div className="modal-header-title-wrap">
              ...
              <h2>{t('editor.componentPicker.title', 'Add Components')}</h2>
            </div>
            ...
            <button
              ...
              title={t('editor.componentPicker.close', 'Close')}
            >
          ...
          <div className="modal-header-controls">
            <div className="header-search-wrapper">
              ...
              <input
                ...
                placeholder={t('editor.componentPicker.searchPlaceholder', 'Search components...')}
                value={searchQuery}
                onChange={(e) => {
            ...
            >
              <option value="all">{t('editor.componentPicker.allComponents', 'All')}</option>
              {categories
                .filter((c) => c !== 'boards')
                .map((category) => (
              ...
              {onSelectBoard && (
                <option value="boards">{t('editor.componentPicker.boards', 'Boards')}</option>
              )}
            </select>
          </div>
        </div>
            ...
            <div className="components-scroll" onScroll={clearHover}>
              {selectedCategory === 'all' && onSelectBoard && (
                <div
                  ...
                  style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.08)', paddingBottom: 10, marginBottom: 6 }}
                >
                  {allBoards.filter(
                    (k) =>
                      !searchQuery ||
