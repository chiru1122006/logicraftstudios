...
export const SEO_ROUTES: SeoRoute[] = [
  // ── Main pages
  {
    ...
    seoMeta: {
      title:
        'Logicraft Studios — Free Online Circuit & Arduino Simulator | SPICE · ESP32 · RP2040 · ATtiny85 · Custom Chips',
      description:
        'Logicraft Studios is a free, open-source online circuit simulator. Real-time SPICE analog simulation (ngspice-WASM) wired to 19 boards: Arduino Uno/Mega/ATtiny85 (AVR8), ESP32 (Xtensa QEMU), ESP32-C3/CH32V003 (RISC-V via QEMU libqemu-riscv32), Raspberry Pi Pico (RP2040), Raspberry Pi 3 (Linux). Build custom chips in C/Rust. 100+ components, oscilloscope, voltmeter, ammeter — no cloud.',
      url: `${DOMAIN}/`,
    },
  },
  {
    ...
    seoMeta: {
      title: 'Multi-Board Simulator Editor — Arduino, ESP32, RP2040, RISC-V | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    changefreq: 'weekly',
    seoMeta: {
      title: 'Circuit & Arduino Simulator Examples — 100+ Sketches & Analog Projects | Logicraft Studios',
      description:
  ...
  // ── SEO keyword landing pages
  {
    ...
    changefreq: 'weekly',
    seoMeta: {
      title: 'Free Online Circuit Simulator — SPICE Analog Simulation in Your Browser | Logicraft Studios',
      description:
        'Logicraft Studios is a free online circuit simulator with real-time SPICE analog simulation via ngspice-WASM. 100+ components — resistors, capacitors, op-amps, transistors, regulators, diodes — wired to Arduino, ESP32, RP2040 firmware. Live oscilloscope, voltmeter, ammeter. No install, no account.',
  ...
  },
  {
    ...
    changefreq: 'weekly',
    seoMeta: {
      title: 'Free Online SPICE Simulator — ngspice in Your Browser | Logicraft Studios',
      description:
        'Run SPICE simulations directly in your browser. Logicraft Studios uses ngspice compiled to WebAssembly via eecircuit-engine — full transient analysis, real device models (BJTs, MOSFETs, op-amps, diodes), Modified Nodal Analysis. Free and open-source.',
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Free Online Electronics Simulator — Build & Test Circuits in Your Browser | Logicraft Studios',
      description:
        'Logicraft Studios is a free online electronics simulator with SPICE-accurate analog parts and 19 simulated microcontrollers. Build, wire, and test electronic circuits — Arduino, ESP32, RP2040, ATtiny85 — in your browser. 100+ components, no install, no account.',
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Custom Chip Simulator — Build Your Own ICs in C, Rust & AssemblyScript | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Free ATtiny85 Simulator — Cycle-Accurate AVR Emulation Online | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Free Online Arduino Simulator — Run Sketches in Your Browser | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Arduino Emulator — Real AVR8 & RP2040 Emulation, Free | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'ATmega328P Simulator — Free Browser-Based AVR8 Emulation | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Arduino Mega 2560 Simulator — Free Online AVR8 Emulator | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Free ESP32 Simulator Online — Xtensa LX6 Emulation | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Free ESP32-S3 Simulator — Xtensa LX7 Emulation Online | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Free ESP32-C3 & RISC-V Simulator — QEMU Emulation | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Free Raspberry Pi Pico Simulator — RP2040 ARM Cortex-M0+ Emulation | Logicraft Studios',
      description:
  ...
  },
  {
    ...
    seoMeta: {
      ...
      // logicraftstudios.tech and Velxio Desktop (2026-09-06). The page still targets
      // the same query, it just stops promising a price it does not have.
      title: 'Raspberry Pi 3 Simulator — Full Linux Emulation in Your Browser | Logicraft Studios',
      description:
  ...
  // ── Release pages
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Logicraft Studios 2.0 — Multi-Board Embedded Simulator | ESP32, Raspberry Pi, Arduino, RISC-V',
      description:
        'Logicraft Studios 2.0 is here. Simulate Arduino, ESP32, Raspberry Pi Pico, and Raspberry Pi 3 in your browser. 19 boards, 68+ examples, realistic sensor simulation. Free and open-source.',
      url: `${DOMAIN}/`,
    },
  },
  {
    ...
    seoMeta: {
      title:
        'Logicraft Studios 2.5 — Arduino + SPICE Analog Circuit Simulator in Your Browser | ngspice-WASM',
      description:
        'Logicraft Studios 2.5 brings real-time analog circuit simulation via ngspice-WASM. Hybrid digital + analog co-simulation: resistors, capacitors, inductors, op-amps, transistors, voltmeters, ammeters — wired to Arduino, ESP32, RP2040 GPIO/ADC. 40+ circuit examples. Free and open-source.',
      url: `${DOMAIN}/`,
    },
  },
  {
    ...
    seoMeta: {
      title:
        'Logicraft Studios 3.0 — Retro CPUs, MicroSD, ePaper & Multi-Board Embedded Simulator',
      description:
        'Logicraft Studios 3.0 adds programmable retro CPUs (Z80, 8080, 4004, 4040, 8086), MicroSD card emulation, ePaper displays, true multi-board UART/I2C/SPI interconnect, full undo/redo and 100+ new examples. Free, open-source, browser-based — Arduino, ESP32, RP2040, STM32, Raspberry Pi and more.',
      url: `${DOMAIN}/v3`,
    },
  },
  ...
  // ── About
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'About Logicraft Studios — Open Source Embedded Emulator by Chirudeep Reddy',
      description:
        'Learn about Logicraft Studios, the free open-source multi-board embedded emulator, and its creator Chirudeep Reddy — ECE Student at Amrita Vishwa Vidyapeetham, Bengaluru.',
      url: `${DOMAIN}/about`,
    },
  },
  ...
  // ── Classroom (institutional sales landing) — Phase 3 D3.7
  {
    ...
    changefreq: 'monthly',
    seoMeta: {
      title: 'Logicraft Studios for educators — full Pro features for your classroom',
      description:
        'Logicraft Studios for Classroom gives every student in your course Pro-tier access (private projects, GitHub Sync, BOM and schematic exports, offline desktop) under a single institution contract. From $40/student/year with volume discounts.',
