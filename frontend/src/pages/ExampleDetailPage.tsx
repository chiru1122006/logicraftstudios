...
export const ExampleDetailPage: React.FC = () => {
  ...
  const seoTitle = example
    ? `${example.title} — Free Arduino Simulator Example | Logicraft Studios`
    : 'Example Not Found | Logicraft Studios';
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              provider: { '@type': 'Organization', name: 'Logicraft Studios', url: DOMAIN },
