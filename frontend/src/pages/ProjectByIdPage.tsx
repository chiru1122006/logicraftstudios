...
export const ProjectByIdPage: React.FC = () => {
  ...
  useSEO(
    projectMeta && projectMeta.isPublic
      ? {
          title: `${projectMeta.name} by ${projectMeta.ownerUsername} | Logicraft Studios`,
          description: projectMeta.description
            ? `${projectMeta.description} — Simulate and remix this Arduino project on Logicraft Studios.`
            : `Arduino project by ${projectMeta.ownerUsername}. View and simulate it free on Logicraft Studios.`,
          url: `${DOMAIN}/project/${id}`,
        }
      : {
          title: 'Project — Logicraft Studios Circuit & Arduino Simulator',
          description:
            'View and simulate this Arduino project on Logicraft Studios — free, open-source multi-board emulator.',
          url: `${DOMAIN}/editor`,
          noindex: true,
        },
  );
