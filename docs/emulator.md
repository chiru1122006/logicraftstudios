...
Toolchain pinned to **arduino-esp32 3.3.10 (IDF 5.5.4)**, the same pair logicraftstudios.tech builds with. ESP-IDF projects (`idf.py`) supported via the [espidf_compiler](../backend/app/services/espidf_compiler.py) wrapper.
