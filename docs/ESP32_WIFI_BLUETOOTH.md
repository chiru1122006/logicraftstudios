...
- **ESP-IDF (producción)**: Los sketches ESP32 se compilan con ESP-IDF 5.5.4 y el core arduino-esp32 3.3.10 en lugar de arduino-cli (lo mismo que logicraftstudios.tech). El backend traduce automáticamente Arduino WiFi/WebServer a ESP-IDF C nativo. Verifica que `IDF_PATH` esté configurado.
