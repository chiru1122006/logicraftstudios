...
```
https://github.com/chiru1122006/qemu-lcgamboa
...
load it into logicraftstudios.tech's asset store with `scripts/upload-binary.sh`, where the
...
BASE=https://logicraftstudios.tech/api/pro/license/downloads
