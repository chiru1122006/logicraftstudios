...
### 8.1 Recommended — let the CI build, then publish to logicraftstudios.tech
...
beside the binary and logicraftstudios.tech is where it does.
...
`chiru1122006/qemu-lcgamboa`, or run the workflow manually
