...
|       Web: http://localhost:3080 (Docker) or logicraftstudios.tech             |
...
| Surface | Status | Doc |
|---------|--------|-----|
| **Web (OSS + Pro)** | Stable, deployed at logicraftstudios.tech | This repo |
...
- **logicraftstudios.tech** — Pro overlay layered on the base image. Lives in [velxio/velxio-prod](https://github.com/velxio/velxio-prod) (private).
