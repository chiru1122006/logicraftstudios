...
1. **[Hosted (web)](#option-1-use-the-hosted-version)** — open logicraftstudios.tech, no install.
...
Open the live editor at [logicraftstudios.tech](https://logicraftstudios.tech) — no install needed.
...
# 3.x line so logicraftstudios.tech sketches compile:
arduino-cli config add board_manager.additional_urls \
...
Download from [logicraftstudios.tech/download](https://logicraftstudios.tech/download). See [docs/desktop-app.md](./desktop-app.md) for install paths, license flow, and the offline grace banner.

---

## Your First Simulation

1. **Open the editor** at [logicraftstudios.tech/editor](https://logicraftstudios.tech/editor) or your local instance.
...
- **GitHub:** [github.com/chiru1122006/velxio](https://github.com/chiru1122006/velxio)
- **Discord:** [discord.gg/3mARjJrh4E](https://discord.gg/3mARjJrh4E)
- **Live demo:** [logicraftstudios.tech](https://logicraftstudios.tech)
- **Sponsor:** [github.com/sponsors/chiru1122006](https://github.com/sponsors/chiru1122006)
