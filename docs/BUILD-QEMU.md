...
curl "https://logicraftstudios.tech/api/pro/license/downloads?key=$VELXIO_LICENSE_KEY"

# Fetch one.
curl -O -J \
  "https://logicraftstudios.tech/api/pro/license/downloads/qemu-source-83a944ce?key=$VELXIO_LICENSE_KEY"
```

Free personal keys are at
[`logicraftstudios.tech/license/signup`](https://logicraftstudios.tech/license/signup). The
