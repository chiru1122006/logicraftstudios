...
export const AppHeader: React.FC<AppHeaderProps> = ({ autoSave }) => {
  ...
  // live elsewhere in desktop: title bar shows "Logicraft Studio Desktop", the
  // native menubar has File/Edit/View/Help, auto-save is a Pro cloud
  // feature (desktop saves to .vlx), share generates a logicraftstudios.tech URL
      ...
      <div className="header-content">
        <div className="header-left">
          ...
          <div className="header-brand">
            <Link to={localize('/')} style={{ textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center', gap: 10 }}>
              <img src="/logicraft.png" alt="Logicraft Studio Logo" style={{ width: 26, height: 26, objectFit: 'contain' }} />
              <span className="header-title">Logicraft Studio</span>
            </Link>
          </div>
