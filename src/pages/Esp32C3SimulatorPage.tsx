...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Yes. The ESP32-C3 uses the RISC-V RV32IMC instruction set. Logicraft Studio also supports the CH32V003 (RV32EC at 48 MHz) — another popular RISC-V microcontroller.',
  },
  {
    q: 'Which ESP32-C3 boards are supported?',
    a: 'Logicraft Studio supports ESP32-C3 DevKitM-1, Seeed XIAO ESP32-C3, and ESP32-C3 SuperMini (Aitewinrobot). All three use the same RISC-V core.',
  },
  {
    q: 'Can I use Arduino code with ESP32-C3?',
    a: 'Yes. Logicraft Studio compiles your .ino sketch using the official ESP32 Arduino core with the ESP32-C3 board target. All standard Arduino functions work — Serial, GPIO, analogRead, etc.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Logicraft Studio — Free ESP32-C3 & RISC-V Simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Logicraft Studio', item: 'https://logicraftstudios.tech/' },
      {
        ...
        item: 'https://logicraftstudios.tech/esp32-c3-simulator',
      },
    ],
  },
];
