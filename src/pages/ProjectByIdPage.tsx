...
export const ProjectByIdPage: React.FC = () => {
  ...
  useSEO(
    projectMeta && projectMeta.isPublic
      ? {
          title: `${projectMeta.name} by ${projectMeta.ownerUsername} | Logicraft Studio`,
          description: projectMeta.description
            ? `${projectMeta.description} — Simulate and remix this Arduino project on Logicraft Studio.`
            : `Arduino project by ${projectMeta.ownerUsername}. View and simulate it free on Logicraft Studio.`,
          url: `${DOMAIN}/project/${id}`,
        }
      : {
          title: 'Project — Logicraft Studio Arduino Emulator',
          description:
            'View and simulate this Arduino project on Logicraft Studio — free, open-source multi-board emulator.',
          url: `${DOMAIN}/editor`,
          noindex: true,
        },
  );
