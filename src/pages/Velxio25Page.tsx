...
const JSON_LD: object[] = [
  {
    ...
    name: 'Logicraft Studio 2.5 — Arduino + SPICE Analog Circuit Simulator',
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Logicraft Studio 2.5', item: 'https://logicraftstudios.tech/v2-5' },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'What is new in Logicraft Studio 2.5?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Logicraft Studio 2.5 adds real-time analog circuit simulation via ngspice-WASM. You can now mix SPICE-accurate analog parts — resistors, capacitors, inductors, diodes, transistors, op-amps, voltage regulators — with Arduino, ESP32, and RP2040 boards on the same canvas. Includes live ammeters, voltmeters, an oscilloscope, and 40+ new circuit examples.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes. Logicraft Studio 2.5 runs ngspice compiled to WebAssembly (via eecircuit-engine) entirely in the browser. No server, no install, no account. Works offline after first load.',
        },
      },
      {
        '@type': 'Question',
        ...
        <section className="seo-section">
          ...
          <div className="v2-repos">
            <a href="https://ngspice.sourceforge.io/" target="_blank" rel="noopener noreferrer" className="v2-repo-card">
              ...
              <div>
                <h3>ngspice</h3>
                <p>The open-source SPICE circuit simulator — powers every analog solve in Logicraft Studio 2.5</p>
              </div>
            </a>
