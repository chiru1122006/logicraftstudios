...
const FAQ_ITEMS = [
  ...
  {
    q: "How accurate is Logicraft Studio's Arduino emulation?",
    a: 'Logicraft Studio uses avr8js, which provides cycle-accurate AVR8 instruction emulation. Every AVR opcode is faithfully emulated at 16 MHz, making it reliable for developing and debugging real firmware before flashing to hardware.',
  },
  {
    q: 'Which Arduino boards can Logicraft Studio emulate?',
  ...
  {
    q: 'How is Logicraft Studio different from Wokwi?',
    a: 'Logicraft Studio is fully self-hosted and open-source under GNU AGPLv3. It uses the same avr8js emulation library as Wokwi but runs entirely on your own machine — no cloud dependency, no registration, no subscription.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Logicraft Studio Arduino Emulator',
    ...
    url: 'https://logicraftstudios.tech/arduino-emulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Logicraft Studio', item: 'https://logicraftstudios.tech/' },
      {
        ...
        item: 'https://logicraftstudios.tech/arduino-emulator',
      },
    ],
  },
];
