    ...
    <div className="docs-section">
      ...
      <div className="docs-callout">
        <Trans
          ...
          components={{
            strong: <strong />,
            a: <a href="https://logicraftstudios.tech" target="_blank" rel="noopener noreferrer" />,
          }}
        />
      </div>
    </div>
...
const GettingStartedSection: React.FC = () => {
  ...
  -p 3080:80 \\
  -v $(pwd)/data:/app/data \\
  ghcr.io/chiru1122006:master`}</CodeBlock>
      <p>
      ...
      <CodeBlock language="bash">{`git clone https://github.com/chiru1122006.git
cd velxio`}</CodeBlock>
      ...
      <ol>
        <li>
          <Trans
            ...
            components={{
              strong: <strong />,
              a: <a href="https://logicraftstudios.tech/editor" target="_blank" rel="noopener noreferrer" />,
            }}
          />
        </li>
        <li>
      ...
      <p>
        <Trans
          ...
          components={{
            a: (
              <a
                href="https://github.com/chiru1122006/blob/master/docs/RP2040_EMULATION.md"
                target="_blank"
                rel="noopener noreferrer"
              />
            ),
      ...
      <p>
        <Trans
          ...
          components={{
            a: (
              <a
                href="https://github.com/chiru1122006/blob/master/docs/RASPBERRYPI3_EMULATION.md"
                target="_blank"
                rel="noopener noreferrer"
              />
            ),
...
//
// Transparency section. The Logicraft Studio docker image ships with prebuilt
...
const BuildQemuSection: React.FC = () => {
  return (
    <div className="docs-section">
      ...
      <p>
        Logicraft Studio ships with prebuilt <code>libqemu-xtensa.so</code> and{' '}
        <code>libqemu-riscv32.so</code> so ESP32 / ESP32-S3 / ESP32-C3
        simulation works the moment you pull the docker image. The
        prebuilts are a convenience — Logicraft Studio is <strong>AGPLv3</strong>{' '}
...
# → produces libqemu-riscv32.so (~45 MB)`}</code></pre>
      ...
      <p>
        ...
        inside the running Logicraft Studio container (or whatever host path you
      ...
      <p>
        ...
        failures, and the licensing notes (QEMU is GPL-2.0, Logicraft Studio is
        AGPLv3, the dlopen boundary keeps them orthogonal) live in the
        full document:
      </p>
      <p>
        <a
          href="https://github.com/chiru1122006/blob/master/docs/BUILD-QEMU.md"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <p>
        ...
        <a
          href="https://logicraftstudios.tech/license/signup"
          target="_blank"
          rel="noopener noreferrer"
        >
          logicraftstudios.tech/license/signup
        </a>{' '}
        (free personal-use key, takes a minute), and the existing
        public release at <code>github.com/chiru1122006
      ...
      '@graph': [
        {
          ...
          url: pageUrl,
          isPartOf: { '@type': 'WebSite', url: `${BASE_URL}/`, name: 'Logicraft Studio' },
          inLanguage: 'en-US',
          author: AUTHOR,
        },
        {
