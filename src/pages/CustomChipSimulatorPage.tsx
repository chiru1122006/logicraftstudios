...
const FAQ_ITEMS = [
  {
    q: 'What is a custom chip in Logicraft Studio?',
    a: 'A custom chip is a user-defined integrated circuit. You write the chip\'s logic in C, Rust, or AssemblyScript — Logicraft Studio compiles it to WebAssembly, instantiates it on the canvas like any other component, and drives its pins from the simulator.',
  },
  {
    q: 'Which API does Logicraft Studio use?',
    a: 'Logicraft Studio implements the Wokwi Custom Chips API — the same API used by Wokwi — so chips you write for Velxio are portable to Wokwi and vice versa. Velxio adds a WASI shim so you can use standard library functions in your chip code.',
  },
  {
    q: 'What can I build?',
  ...
  },
  {
    ...
    a: 'Save the chip to your Logicraft Studio account and reuse it across projects. The chip definition includes its pin layout, attributes, and the compiled WASM — drop it onto any project canvas like a built-in component.',
  },
  {
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Logicraft Studio — Free Online Custom Chip Simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Logicraft Studio', item: 'https://logicraftstudios.tech/' },
      {
        ...
        item: 'https://logicraftstudios.tech/custom-chip-simulator',
      },
    ],
  },
];
