...
const JSON_LD: object[] = [
  {
    ...
    name: 'Logicraft Studio 2.0 — Multi-Board Embedded Systems Simulator',
    applicationCategory: 'DeveloperApplication',
    operatingSystem: 'Any (browser-based)',
    softwareVersion: '2.0.0',
    description:
      'Logicraft Studio 2.0 — simulate Arduino, ESP32, Raspberry Pi Pico, and Raspberry Pi 3 in your browser. 19 boards, 68+ examples, realistic sensor simulation. Free and open-source.',
    url: 'https://logicraftstudios.tech/v2',
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Logicraft Studio 2.0', item: 'https://logicraftstudios.tech/v2' },
    ],
  },
];
    ...
    <div className="seo-page">
      ...
      <main>
        ...
        <section className="seo-section">
          ...
          <p className="lead">
            Most simulators limit you to one board at a time. Logicraft Studio lets you place multiple boards
