...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes. Logicraft Studio is completely free and open-source (GNU AGPLv3). Simulate RP2040 code in your browser — no Raspberry Pi hardware needed, no account, no payment.',
  },
  {
    q: 'How does the RP2040 emulation work?',
    a: 'Logicraft Studio uses rp2040js — the open-source RP2040 emulator — to simulate the ARM Cortex-M0+ CPU at 133 MHz. Your code is compiled with the official Arduino-Pico core by Earle Philhower.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. Logicraft Studio compiles your .ino sketch using the arduino-pico core (by Earle Philhower). Standard Arduino functions like Serial, digitalWrite, analogRead, and I2C/SPI work out of the box.',
  },
  {
