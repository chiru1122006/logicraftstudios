...
export const ExampleDetailPage: React.FC = () => {
  ...
  const seoTitle = example
    ? `${example.title} — Free Arduino Simulator Example | Logicraft Studio`
    : 'Example Not Found | Logicraft Studio';
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              provider: { '@type': 'Organization', name: 'Logicraft Studio', url: DOMAIN },
