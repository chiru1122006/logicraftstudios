...
const FAQ_ITEMS = [
  {
    q: 'Is Logicraft Studio a complete electronics simulator?',
    a: 'Yes. Logicraft Studio combines a SPICE-accurate analog solver, 19 simulated microcontrollers (Arduino, ESP32, RP2040, ATtiny85, Raspberry Pi 3), 100+ components, an oscilloscope, voltmeter, ammeter, and signal generator — everything you need to design and validate an electronics project end-to-end.',
  },
  {
  ...
  {
    q: 'Is Logicraft Studio a Tinkercad / Falstad alternative?',
    a: 'Yes — and a more accurate one. Logicraft Studio runs real ngspice (the engine professional EDA tools use), and unlike those tools it also runs the firmware on the microcontroller driving the circuit. Open-source under AGPLv3.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Logicraft Studio — Free Online Electronics Simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Logicraft Studio', item: 'https://logicraftstudios.tech/' },
      {
        ...
        item: 'https://logicraftstudios.tech/electronics-simulator',
      },
    ],
  },
];
