  ...
  useSEO({
    ...
    jsonLd: {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'Is Logicraft Studio free?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. Logicraft Studio is completely free and open-source under the GNU AGPLv3 license. No account required, no cloud subscription. Run it at logicraftstudios.tech or self-host with one Docker command.',
          },
        },
        {
          '@type': 'Question',
          name: 'Can Logicraft Studio simulate analog circuits?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. Logicraft Studio 2.5 includes real-time SPICE analog simulation via ngspice compiled to WebAssembly. You can mix passive and active analog parts (resistors, capacitors, op-amps, BJTs, MOSFETs, regulators, diodes) with Arduino, ESP32, and RP2040 firmware on the same canvas — GPIO drives SPICE nets, ADC reads solved node voltages.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. Logicraft Studio implements the Wokwi Custom Chips API. Write your chip in C, Rust, or AssemblyScript; Logicraft Studio compiles it to WebAssembly and runs it on the canvas like any other component, with pin I/O, attribute reads, timers, and I²C/SPI bus integration.',
          },
        },
        {
          '@type': 'Question',
          name: 'Does Logicraft Studio work offline?',
          acceptedAnswer: {
            '@type': 'Answer',
        ...
        {
          '@type': 'Question',
          name: 'What boards does Logicraft Studio support?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Logicraft Studio supports 30+ boards across 6 CPU architectures: AVR8 (Arduino Uno, Nano, Mega 2560, ATtiny85), RP2040 (Raspberry Pi Pico, Pico W), Xtensa QEMU (ESP32, ESP32-S3, ESP32-CAM, Nano ESP32), RISC-V QEMU (ESP32-C3, XIAO ESP32-C3), ARM Cortex-M QEMU (STM32 Blue Pill, Black Pill, F401, F4 Discovery, Netduino, Olimex H405), and ARM Cortex-A QEMU (Raspberry Pi 3, 4 and 5 running Linux).',
          },
        },
        {
          '@type': 'Question',
          name: 'Is Logicraft Studio a Wokwi / Falstad / Tinkercad alternative?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Yes. Logicraft Studio is a free, self-hosted alternative to Wokwi for microcontroller simulation, and a more accurate alternative to Falstad and Tinkercad for analog circuits — Velxio runs the real ngspice engine and also runs the firmware on the microcontroller driving the circuit, all in one tool.',
          },
        },
      ],
    },
    ...
    <div className="landing">
      ...
      <section className="landing-hero">
        <div className="hero-left">
          ...
          {/*
            Slot for the pro overlay's OS-detect Logicraft Studio Desktop download
      ...
      <section className="landing-section landing-licensing">
        ...
        <div className="licensing-grid">
          ...
          <div className="licensing-card">
            ...
            <a
              href="mailto:info@logicraftstudios.tech?subject=Logicraft Studio%20commercial%20license"
              className="licensing-card-link"
            >
