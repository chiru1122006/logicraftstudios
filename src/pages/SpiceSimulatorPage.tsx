...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes. Logicraft Studio loads ngspice compiled to WebAssembly via the open-source eecircuit-engine. The same SPICE engine that powers professional EDA workflows runs in your browser tab — no server, no install.',
  },
  {
  ...
  },
  {
    ...
    a: 'Logicraft Studio builds the netlist for you from the schematic — wire components on the canvas and the simulator generates the SPICE cards. You don’t have to handwrite netlists, but the underlying engine is full ngspice and accepts standard device cards.',
  },
  {
...
const JSON_LD: object[] = [
  {
    ...
    name: 'Logicraft Studio — Free Online SPICE Simulator (ngspice-WASM)',
    ...
    url: 'https://logicraftstudios.tech/spice-simulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Logicraft Studio', item: 'https://logicraftstudios.tech/' },
      {
        ...
        item: 'https://logicraftstudios.tech/spice-simulator',
      },
    ],
  },
];
