...
3. Run **`Velxio: Sign In`** from the command palette. Your browser
   opens `https://logicraftstudios.tech/auth/vscode`; sign in (or create an
...
[Account → My licenses](https://logicraftstudios.tech/account/licenses).
...
| `Velxio: Sign In`            | Browser-based sign-in via logicraftstudios.tech. |
...
| `velxio.licenseApiBase`   | `https://logicraftstudios.tech`  | License validation endpoint. **Override only for development.** |

## Pricing

- **Free trial** — 30 days, full Velxio Pro features, no credit card.
- **Pro $15/mo** — unlocks the VS Code extension, the Velxio Desktop
  app, and the premium components on logicraftstudios.tech.
- **Pro Max $35/mo** — everything in Pro plus the in-app AI assistant
  and priority simulation queue.

Manage your subscription at <https://logicraftstudios.tech/billing>.

## Troubleshooting

- **`Velxio requires an internet connection`** — the extension cannot
  reach `https://logicraftstudios.tech/api/pro/license/validate`. Check your
  network, VPN, and any corporate proxy.
- **`Your trial has ended`** — start a Pro subscription at
  <https://logicraftstudios.tech/billing>. Existing trial keys re-activate
...
arch to `https://logicraftstudios.tech` for validation. No sketch contents, file
paths, or telemetry leave your machine. See the
[Velxio privacy policy](https://logicraftstudios.tech/privacy) for the full
picture.
