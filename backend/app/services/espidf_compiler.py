...
def _max_build_variants(idf_target: str) -> int:
    ...
    default. Per target because the hot target on logicraftstudios.tech rotates through
...
# logicraftstudios.tech the dominant configuration (the default esp32 blink, no
...
def _ninja_parallelism_args() -> list[str]:
    ...
    Unset (the OSS default) leaves ninja's own choice, nproc + 2. logicraftstudios.tech
