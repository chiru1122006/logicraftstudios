...
fetching logicraftstudios.tech directly, the backend proxies the public feed:
...
DEFAULT_FEED_URL = "https://logicraftstudios.tech/api/pro/news/feed"
...
def _news_enabled() -> bool:
    return os.environ.get("VELXIO_NEWS", "off").strip().lower() not in (
...
async def news_feed() -> list[dict]:
    """Cached proxy of the logicraftstudios.tech product-news feed.
