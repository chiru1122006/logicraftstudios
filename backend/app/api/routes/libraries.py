...
async def install_library(
    ...
    On logicraftstudios.tech this WARMS the shared content-addressed cache (the global
...
def _uninstall_allowed(requester_id: str | None) -> bool:
    ...
    "logicraftstudios.tech, not signed in". They are told apart by whether the overlay
